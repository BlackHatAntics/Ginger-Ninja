...
namespace Colors
{
	...
	static constexpr Color Red2 = MakeRGB(206u, 28u, 28u);
	static constexpr Color Green2 = MakeRGB(100u, 255u, 60u);
	...
	static constexpr Color Indicator = MakeRGB(20u, 20u, 85u);
}